...
|---|---|---|
| `plan` | approved entries only — inside the rule | `render_height_ladder`, `render_step_positions`, `render_plates`, `render_chamfers`, `render_circular_blind_steps`, `render_fillets`, `render_flats`, `render_grooves`, `render_paired_ramp_steps`, `render_through_steps`, `render_boss_diameters`, `render_polygonal_bosses`, `render_boss_heights`, `render_envelope`, `render_pockets`, `render_rectangular_blind_slots`, `render_round_bottom_blind_slots`, `render_oriented_slots`, `render_pocket_patterns`, `render_slot_patterns`, `render_diameters`, `render_rotational`, `render_step_lengths`, `render_locations`, `render_slots` (+ the prismatic detail redraw) |
