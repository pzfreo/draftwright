...
the drawing path could not be checked, so the cost is accepted rather than overlooked; issue #1462
tracks whether that trade should be revisited. In practice a plain block inspects in about
