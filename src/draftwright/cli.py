...
def main(
    ...
    approved_by: str = typer.Option("", help="Approval person (ISO 7200 5.3.4)"),
    document_type: str = typer.Option("", help="Document type (ISO 7200 5.3.6)"),
    sheet: str = typer.Option("", help="Sheet number, e.g. 1/1 (ISO 7200 5.1.6)"),
