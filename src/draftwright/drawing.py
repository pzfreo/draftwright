...
class Drawing:
    ...
    def export_pdf(self, out=None) -> str:
        """Write a PDF rendered from the SVG (via ``cairosvg``, a core dependency).
        Calls :meth:`export` first if the SVG hasn't been written yet.  Returns the
        PDF path.
        ...
        try:
            ...
            raise ImportError(
                "PDF export requires cairosvg (a core dependency); reinstall draftwright"
            ) from exc
