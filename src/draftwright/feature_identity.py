...
_ORIENTED_SLOT_TYPES: tuple[type, type] | None = None


def register_oriented_slot_feature_type(feature_type: type, passage_type: type) -> None:
    ...
    if _ORIENTED_SLOT_TYPES is None:
        _ORIENTED_SLOT_TYPES = (feature_type, passage_type)
    elif _ORIENTED_SLOT_TYPES != (feature_type, passage_type):
