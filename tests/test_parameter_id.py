...
_SAMPLES: dict[str, ir.Feature] = {
    ...
    "OrientedSlotFeature": ir.OrientedSlotFeature(
        frame=_F,
        width_direction=(-0.5, 0.8660254037844386, 0.0),
        long_direction=(0.8660254037844386, 0.5, 0.0),
        run_direction=(0.0, 0.0, 1.0),
        width=8.0,
        length=30.0,
        passage=ir.OrientedSlotPassage(
            origin=(0.0, 0.0, 0.0),
            run=(0.0, 0.0, 1.0),
            u=(1.0, 0.0, 0.0),
            v=(0.0, 1.0, 0.0),
            ...
            boundary=(
                ((-14.99038105676658, -4.0358983848622465), 0.0),
                ((-10.99038105676658, -10.964101615137753), 0.0),
                ((14.99038105676658, 4.0358983848622465), 0.0),
                ((10.99038105676658, 10.964101615137753), 0.0),
            ),
            low_capped=False,
    ...
    "PolygonalStockFeature": ir.PolygonalStockFeature(
        ir.Frame((0.0, 0.0, 6.0), "z"),
        side_count=6,
        across_flats=20.0,
        length=12.0,
    ...
    "ExternalSpurGearFeature": ir.ExternalSpurGearFeature(
        _F,
        tooth_count=13,
        module=1.25,
        pressure_angle=20.0,
    ...
    "GussetRibFeature": ir.GussetRibFeature(
        frame=ir.Frame((0.0, 17.0, 8.0), "x"),
        axis="x",
        supports=(("y", 17.0), ("z", 8.0)),
        legs=(22.0, 26.0),
        directions=(-1, 1),
        member_bounds=((-32.0, -26.0), (26.0, 32.0)),
        datum=-40.0,
        pattern="mirror",
        mirror_plane=("x", 0.0),
    ),
...
_SAMPLE_BINDINGS = {
    ...
    "OrientedSlotFeature": (
        ("oriented_slot_width.length", 8.0),
        ("oriented_slot_length.length", 30.0),
    ),
    "PadFeature": (
    ...
    "PolygonalBossFeature": (
        ("polygon_across_flats.length", 20.0),
        ("boss_height.length", 12.0),
    ),
    "PolygonalStockFeature": (
        ("polygon_across_flats.length", 20.0),
        ("stock_length.length", 12.0),
    ),
    ...
    "GussetRibFeature": (
        ("gusset_thickness.length", 6.0),
        ("gusset_leg.length.y", 22.0),
        ("gusset_leg.length.z", 26.0),
        ("gusset_spacing.length", 58.0),
        ("gusset_location.length", 40.0),
    ),
