...
def test_coverage_combine_follows_the_shard_matrix():
    ...
    (`coverage-data-1 coverage-data-2 coverage-data-3 coverage-data-4 coverage-data-5`) is a third place to keep
    ...
    assert "--splits 5" in shards and "shard: [1, 2, 3, 4, 5]" in shards, (
